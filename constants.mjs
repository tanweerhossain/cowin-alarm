...
/** Sample District checking */
export const specificDistrict = [{
  "state_id": 1,
  "state_name": "Andaman and Nicobar Islands",
  "districtDetails": [
    {
...
export const minAge = 45; // { 18 | 45 }
export const vaccineType = 'SPUTNIK V'; // { 'COVAXIN' | 'COVISHIELD' |  'SPUTNIK V' }
export const available_capacity_dose_X = 'available_capacity_dose1'; // { available_capacity_dose1 | available_capacity_dose2 }
/** Watching interval */
export const loopCheckingInterval = 5000;  // in milliSec
/** System path to Audio/Video file */
export const pathForWarningFile = '/home/--absolute-path--/Warning\ Alarm\ Sound\ Effects.mp4'; // For windows: { C:\--path--\Audio.mp4 }
export const AudioOrVideoPlayer = 'vlc'; // { 'vlc' | 'C:\--path--\vlc.exe' }